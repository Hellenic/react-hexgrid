...
export function calculateCoordinates(circumradius, angle = 0, center = new Point(0, 0), rings = 0) {
    ...
    if (rings <= 0) {
        ...
        let offset = -1;
        c = [
            new Point(center.x + 0.5 * circumradius, offset + center.y + 4.3301274 * circumradius),
            new Point(center.x + -0.5 * circumradius, offset + center.y + 4.3301274 * circumradius),
            new Point(center.x + -0.5 * circumradius, offset + center.y + 4.3301274 * circumradius),
            new Point(center.x + -1.0 * circumradius, offset + center.y + 3.4641017 * circumradius),
            new Point(center.x + -1.0 * circumradius, offset + center.y + 3.4641017 * circumradius),
            new Point(center.x + -2.0 * circumradius, offset + center.y + 3.4641014 * circumradius),
            new Point(center.x + -2.0 * circumradius, offset + center.y + 3.4641014 * circumradius),
            new Point(center.x + -2.5 * circumradius, offset + center.y + 2.598076 * circumradius),
            new Point(center.x + -2.5 * circumradius, offset + center.y + 2.598076 * circumradius),
            new Point(center.x + -2.0 * circumradius, offset + center.y + 1.7320505 * circumradius),
            new Point(center.x + -2.0 * circumradius, offset + center.y + 1.7320505 * circumradius),
            new Point(center.x + -2.5 * circumradius, offset + center.y + 0.866025 * circumradius),
            new Point(center.x + -2.5 * circumradius, offset + center.y + 0.866025 * circumradius),
            new Point(center.x + -2.0 * circumradius, offset + center.y + -4e-7 * circumradius),
            new Point(center.x + -2.0 * circumradius, offset + center.y + -4e-7 * circumradius),
            new Point(center.x + -1.0 * circumradius, offset + center.y + -2e-7 * circumradius),
            new Point(center.x + -1.0 * circumradius, offset + center.y + -2e-7 * circumradius),
            new Point(center.x + -0.5 * circumradius, offset + center.y + -0.8660254000000001 * circumradius),
            new Point(center.x + -0.5 * circumradius, offset + center.y + -0.8660254000000001 * circumradius),
            new Point(center.x + 0.5 * circumradius, offset + center.y + -0.8660254000000001 * circumradius),
            new Point(center.x + 0.5 * circumradius, offset + center.y + -0.8660254000000001 * circumradius),
            new Point(center.x + 1.0 * circumradius, offset + center.y + -2e-7 * circumradius),
