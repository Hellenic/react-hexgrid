...
export function HexGrid(_a) {
    ...
    return (_jsx("svg", Object.assign({ className: "grid", preserveAspectRatio: "xMidYMid slice", width: width, height: height, viewBox: viewBox, version: "1.1", xmlns: "http://www.w3.org/2000/svg" }, props)));
}
