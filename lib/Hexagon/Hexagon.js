...
export function Hexagon(props) {
    ...
    return (_jsx("g", Object.assign({ className: classNames("hexagon-group", className), transform: `translate(${pixel.x}, ${pixel.y})` }, rest, draggable, { onDragStart: (e) => {
        ...
        } }, { children: _jsxs("g", Object.assign({ className: "hexagon" }, { children: [_jsx("polygon", { points: ps, fill: fillId ? fillId : `url(#${randomId})`, style: cellStyle }), children, fillUrl ? (_jsx(Pattern, { id: `${randomId}`, link: fillUrl, size: new Point((rings + 1) * 20, (rings + 1) * 20) })) : null] })) })));
}
